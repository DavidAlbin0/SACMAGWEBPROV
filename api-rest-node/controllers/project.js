                    ...
                    if (userFind != "") {
                        ...
                        let transporter = nodemailer.createTransport({
                            ...
                            auth: {
                                ...
                                pass: 'eokwukudparxvhvd', // generated ethereal password
                            },
                        });
                ...
                `;
                        ...
                        if (req.user.empresa == "supter") {
                            ...
                            if (SEARCHARCHIVE == null) {
                                ...
                                var addArchives = [];
                                if (SEARCHARCHIVE.archivo1) addArchives.push(SEARCHARCHIVE.archivo1);
                                ...
                                for (var i = 0; i < addArchives.length; i++) {
                                    await fsa.copyFile(`./../../proveedores Web Subida/api-rest-node/uploads/${addArchives[i]}`, `./uploads/${addArchives[i]}`, (err) => {
                                        if (err) {
